...
namespace Virtuademy.SDK.Environments.Analytics.Editor
{
    ...
    {
        public const string ANALYTICS_SCRIPT_DEFINE_SYMBOL = "VIRTUADEMY_ENVIRONMENTS_ANALYTICS";
        static ScriptDefineSymbols()
        {
            ...
            ScriptDefineSymbolsUtilities.RemoveScriptingDefineSymbolFromAllBuildTargetGroups(ANALYTICS_SCRIPT_DEFINE_SYMBOL.Replace("VIRTUADEMY_ENVIRONMENTS_", "REFLECTIS_CREATOR_KIT_WORLDS_"));
